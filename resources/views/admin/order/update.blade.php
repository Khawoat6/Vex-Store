    ...
    <section class="content" style="position: relative;bottom: 20px">
     <div class="row">
        <div class="col-xs-16" > 
          ...
          <h1 style="position: relative;bottom: 5px;left: 15px;">Update Order Status</h1>
         
     
          <br>
          <div class="col-xs-12" >
            <form action="{{ URL::to('admin/order/update/'.$orders->orderCode)}}" method="post">
              <label class="col-xs-6 control-label">Status:</label> 
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <select class="form-control" id="carm3" name="status" id="status" >
                @if($orders->status == 0)
