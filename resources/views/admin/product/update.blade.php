    ...
    <section class="content" style="position: relative;bottom: 20px">
     <div class="row">
        <div class="col-xs-16" > 
          ...
          <h1 style="position: relative;bottom: 5px;left: 15px;">Edit Product</h1>
         
     
          <br><br>
          <div class="col-xs-12" >
            
             <form action="{{ URL::to('admin/product/update/'.$products->productID)}}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Confirm?')">
            ...
            <div class="col-sm-3">
              <input type="text" class="form-control " maxlength="64"  name="Code" id="Code" value="{{$products->productCode}}" required>
              </div>
            <br><br><br>

            <label class="col-sm-12 control-label">Product Name: </label><br>
            <div class="col-sm-6">
              <input type="text" class="form-control " maxlength="64"  name="Name" id="Name" value="{{$products->productName}}" required>
          </div>
            <br> <br><br>
            ...
            <textarea name = "Detail" id="Detail" type="text" class="form-control"
                   style="border-radius: 3px;resize:none;height: 100px" required>{{$products->productDetail}}</textarea>
            ...
            <div class="col-sm-3">
            <input type="text" class="form-control " maxlength="64"  name="brand" id="brand" value="{{$products->productBrand}}" required>
            ...
            <div class="col-sm-3">
            <input type="text" class="form-control " maxlength="64"  name="Price" id="Price" value="{{$products->productPrice}}" required>
            </div>
            <br><br><br>
            <button class="btn btn-warning" name="action" id="action" type= "submit">Update</button>
             <a href="/admin/product">
