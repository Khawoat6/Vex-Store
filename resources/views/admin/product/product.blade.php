     ...
     <div class="row">
        <div class="col-xs-16" > 
          @if(Session::has('flash_message1'))
            <div class="alert alert-success"><em> <center><li>{!! session('flash_message1') !!}</li></center></em></div></center>
         @endif
         ...
         @endif
          @if(Session::has('flash_message3'))
            <div class="alert alert-success"><em> <center><li>{!! session('flash_message3') !!}</li></center></em></div></center>
         @endif
          <h1 style="position: relative;bottom: 5px;left: 15px;">Product List</h1>
         
          <div class="col-sm-1">
          <a href="/admin/product/addproduct" style="color: white">
        ...
        <tbody>
          @foreach($products as $i=>$product)
            <tr>
              ...
              <td align="center">{{$product->productBrand}}</td>
              <td align="center">{{$product->productPrice}}</td>
              <td align="center">
                 <a style="color: white" 
                          href="{{ URL::to('admin/product/update/'.$product->productID)}}">
                          ...
                          <a style="color: white" 
                          href="{{ URL::to('admin/product/'.$product->productID)}}">
